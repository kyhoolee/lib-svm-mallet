...
public class SVMPredictor {
    ...
    public static double predictProbability(Object data, svm_model model, double[] probabilities) {
        return svm.svm_predict_probability(model, new svm_node(data), probabilities);
    } 
